...
#         torch.backends.cudnn.deterministic = True
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="../GFNet-main/dataset/SemanticKITTI",
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='config/arch/senet-2048p.yml',
    ...
    parser.add_argument(
        '--name', '-n',
        type=str,
        default="senet-SwinTrans-2-2-2-2-2048p",
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default=None, # None or "logs/senet-SwinTrans-2-2-2-2-1024p"
